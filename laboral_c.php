...
echo '<pre>';
echo 'La asignagura Lenguaje de Sistema de Marcas tiene '.count($r['LMS']).' Dias lectivos<br/>';
echo 'La asignagura Fundamentos del Hardware tiene '.count($r['HW']).' Dias lectivos<br/>';
echo '</pre>';
